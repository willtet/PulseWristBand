    ...
    public void run() {
        ...
        if(this.server) {
            ...
            try {
                 ...
                 */
                serverSocket = btAdapter.listenUsingRfcommWithServiceRecord("Super Counter", UUID.fromString(myUUID));
            ...
            try {
                ...
                socket = btDevice.createRfcommSocketToServiceRecord(UUID.fromString(myUUID));
